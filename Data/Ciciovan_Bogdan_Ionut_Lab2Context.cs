...
namespace Ciciovan_Bogdan_Ionut_Lab2.Data
{
    public class Ciciovan_Bogdan_Ionut_Lab2Context : DbContext
    {
        ...
        public DbSet<Ciciovan_Bogdan_Ionut_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Ciciovan_Bogdan_Ionut_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
