...
namespace Ciciovan_Bogdan_Ionut_Lab2.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public OrdersController(Ciciovan_Bogdan_Ionut_Lab2Context context)
        {
            _context = context;
        }
        ...
        {
            var ciciovan_Bogdan_Ionut_Lab2Context = _context.Order.Include(o => o.Book).Include(o => o.Customer);
